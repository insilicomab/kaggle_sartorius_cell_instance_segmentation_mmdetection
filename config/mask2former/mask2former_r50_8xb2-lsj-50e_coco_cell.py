...
data_root = ""
img_dir = {
    "train": "/workspace/data/sartorius-cell-instance-segmentation",
    "val": "/workspace/data/sartorius-cell-instance-segmentation",
    "test": "/workspace/data/sartorius-cell-instance-segmentation",
}
annotation_path = {
    "train": "/workspace/inputs/annotations_train_f0.json",
    "val": "/workspace/inputs/annotations_valid_f0.json",
    "test": "/workspace/inputs/annotations_valid_f0.json",
}
logger_params = {
    "project": "cell-mmdetection",
    "run_name": "mask2former_r50_8xb2-lsj-50e_coco",
}

## models
max_iters = 368750
num_things_classes = 3  # オブジェクトのクラス数
...
load_from = "https://download.openmmlab.com/mmdetection/v3.0/mask2former/mask2former_r50_8xb2-lsj-50e_coco/mask2former_r50_8xb2-lsj-50e_coco_20220506_191028-41b088b6.pth"  # noqa
